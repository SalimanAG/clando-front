...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/rapports/agences', title: 'Agences',  icon:'notifications', class: 'sousMenu3' },
    { path: '/rapports/collecteurs', title: 'Collecteurs',  icon:'notifications', class: 'sousMenu3' },
    { path: '/rapports/collectes', title: 'Collectes',  icon:'notifications', class: 'sousMenu3' },
    { path: '/rapports/tontines', title: 'Tontines',  icon:'notifications', class: 'sousMenu3' },

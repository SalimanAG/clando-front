...
export class EditTontineDialogComponent implements OnInit, AfterViewInit {
  ...
  onValiderTontineSaveClicked(){
    ...
    */
    ...
    let newTontine: Tontine = new Tontine(this.editATontineForm.value['numTont'], this.editATontineForm.value['mise'],
    this.editATontineForm.value['dateDebut'], this.editATontineForm.value['dateFin'],
    collec, client , 
    obj);
    
    this.serviceTontine.editATontine(this.dialogData.tontine.numTont.valueOf(), newTontine).subscribe(
      (data) => {
